...
public class ListView extends VerticalLayout {
    ...
    public ListView(PasswordManagerService service) {
    ...
    private void configureForm() {
        ...
        form.addListener(PasswordForm.SaveEvent.class, this::savePassword);
        form.addListener(PasswordForm.DeleteEvent.class, this::deletePassword);
        form.addListener(PasswordForm.CloseEvent.class, e -> closeEditor());
    }

    private void savePassword(PasswordForm.SaveEvent event) {
        service.savePassword(event.getPassword());
        updateList();
        closeEditor();
    }

    private void deletePassword(PasswordForm.DeleteEvent event) {
